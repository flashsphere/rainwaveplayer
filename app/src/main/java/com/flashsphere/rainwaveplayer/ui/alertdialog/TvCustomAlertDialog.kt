        ...
        Column(modifier = Modifier.padding(DialogPadding)) {
            title?.let {
                CompositionLocalProvider(
                    LocalTextStyle provides LocalTextStyle.current.merge(TvAppTypography.bodyLarge),
                ) {
            ...
            CompositionLocalProvider(
                LocalTextStyle provides LocalTextStyle.current.merge(TvAppTypography.bodyMedium),
            ) {
